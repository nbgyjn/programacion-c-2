...
/** \brief Recibe un arraylist, filtra segun criterio del usuario y devuelve otro con los elementos deseados.
 *
 * \param Lista a filtrar
 * \param Funcion criterio
 * \return Nuevo arrayList o NULL
 *
 */
